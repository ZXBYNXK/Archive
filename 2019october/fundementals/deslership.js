...
var _Rental_Shop_Live = {
  ...
  _Cars: {
    ...
    _Chevys: {
      ...
      _Make_Modals: [
        "2019 Chevorlet Avenger",
        "2019 Chevorlet Camaro",
        "2019 Chevorlet Blazer",
      ],
...
var _Add_Customer = function (name, age, car, liscnum, duedate) {
  ...
  upcustnum();
  var custarr = [
    `| CUSTOMER#: ${custnum} | NAME: ${name} | AGE: ${age} | LISCENCE#: ${liscnum} |`,
  ];
  var outarr = [
    `| CUSTOMER#: ${custnum} | CAR: ${car} | DUEDATE: ${duedate} |`,
  ];
