  ...
  program: {
    ...
    methods: {
      sortEverything: function () {
        let load_salaries = globe.program.modules.fs.readFileSync(
            "./load_salaries.txt",
            "utf8"
          ),
          load_salaries_array = load_salaries
            ...
            .replace(/\n/g, "")
            .split(","),
          load_dept_emp = globe.program.modules.fs.readFileSync(
            "./load_dept_emp.txt",
            "utf8"
          ),
          load_dept_emp_array = load_dept_emp
            ...
            .replace(/\n/g, "")
            .split(","),
          load_employee = globe.program.modules.fs.readFileSync(
            "./load_employee.txt",
            "utf8"
          ),
          load_employee_array = load_employee
            ...
            .replace(/\n/g, "")
            .split(","),
          load_dept_names = globe.program.modules.fs.readFileSync(
            "./load_dept_names.txt",
            "utf8"
          ),
        ...
        sortSend(
          globe.program.templates.departmentSalariesTemplate,
          load_salaries_array,
          globe.program.departmentSalaries
        );
        sortSend(
          globe.program.templates.departmentEmployeesTemplate,
          load_employee_array,
          globe.program.departmentEmployees
        );
        sortSend(
          globe.program.templates.departmentEmployeeStatusTemplate,
          load_dept_emp_array,
          globe.program.departmentEmployeeStatus
        );
        sortSend(
          globe.program.templates.departmentNamesTemplate,
          load_dept_names_array,
          globe.program.departmentNames
        );
      },
      addUpgradedAccounts: function () {
        ...
        function collect(objectValue) {
          let currentValueDeptEmployees, currentValueDeptEmp;
      ...
      displaySalariesTotalForDepartment: function (department) {
        ...
        globe.program.departmentNames.forEach((object) => {
          if (
            department.toUpperCase() === object.departmentName.toUpperCase()
          ) {
        ...
        globe.program.upgradedEmployeeAccountsArray.forEach((object) => {
          if (captureId === object.departmentId) {
            ...
            console.log("");
            console.log(
              `Employee: ${object.firstName} ${object.lastName} | Sex: ${object.gender}  | Salary:$${object.salary} | Employee ID: ${object.employeeId}`
            );
            console.log("");
        ...
        console.log(
          `Total salaries: $${parseFloat(
            total
          )} | Employee Population: ${count}`
        );
        console.log(
          `============================================================================================`
        );
      ...
      displayAllEmployeesInDepartment: function (department) {
        ...
        globe.program.upgradedEmployeeAccountsArray.forEach((object) => {
          if (captureId === object.departmentId) {
            ...
            console.log(
              `Employee: ${object.firstName} ${object.lastName} | Sex: ${object.gender} | Employee ID: ${object.employeeId}`
            );
            console.log(
              "---------------------------------------------------------------------------------------------"
            );
      ...
      searchEverything: function (input) {
        ...
        globe.program.upgradedEmployeeAccountsArray.forEach((object) => {
          if (
            object.firstName.includes(input) ||
            object.lastName.includes(input) ||
            object.gender.includes(input) ||
            object.birthDate.includes(input) ||
            object.salary.includes(input) ||
            object.employeeId.includes(input) ||
            object.employeeId.includes(input)
          ) {
            result.push(object);
          }
      ...
      runReadLineProgram: function () {
        ...
        console.log(
          "| Production,      Quality Managment,         Sales,     |"
        );
        console.log(
          "|                                                        |"
        );
